...
Lupa-asiakirjapalvelu käyttää RAG-hakua (Retrieval-Augmented Generation). Tietokanta sisältää ~9 400 chunkkia lupa- ja rakennusohjeistuksista — 6 maa (FI, SE, DA, NO, PL, DE), 7 kieltä (FI, EN, SE, DA, NO, PL, DE), 20+ hanketyyppiä.
