...
_HANKE_CFG = {
    "BESS": {
        ...
        "context_extra": (
            ...
            "elektrolyytin vuoto-onnettomuussuojaukseen (WHG § 62 -periaate) ja "
            "EMC-suojauksen.\n"
            ...
            "Käytä osiossa '1. Hankkeen kuvaus' ja '2. Perustelut'.\n"
            "- Sähköturvallisuus: KTMp 335/2004 (sähköturvallisuusmääräykset) ja "
            "sähköturvallisuuslaki 1135/2016 — akkujärjestelmä on tarkastettava "
            "Tukes-valtuutetun tarkastuslaitoksen toimesta ennen käyttöönottoa.\n"
            "- Palonsammutus / Tukes S10: Tukes S10-ohje (akkuvarastojen "
            "paloturvallisuus) — automaattinen sammutusjärjestelmä pakollinen. "
            "Kuvaile sammutusaineen valinta (CO₂, inerttikaasu tai vesisumu) "
            "akkukemian perusteella.\n"
            "- ATEX-vyöhykejako: tarkista räjähdysvaarallisten tilojen luokittelu "
            "[ATEX-direktiivi 2014/34/EU; VNa 1439/2020] — akkutilojen luokittelu "
            "Zone 1 tai Zone 2 riippuu tuuletustavasta ja kaasupitoisuuksista.\n"
            "- Terminen karkaaminen (thermal runaway): kuvaa hallintakeinot: "
            "BMS (Battery Management System), solujen välinen terminen eristys, "
            "lämpötila- ja kaasupitoisuusseuranta (H₂, CO), automaattinen hälytys- "
            "ja sammutustoiminto.\n"
            ...
            "- UN 38.3 (litiumakkujen kuljetustestaus): toimittajan esitettävä "
            "vaatimustenmukaisuustodistukset akkumoduulien toimitukselle.\n"
