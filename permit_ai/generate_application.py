...
_HANKE_CFG = {
    "BESS": {
        ...
        "context_extra": (
            ...
            "- PAKOLLINEN osiossa '2. Perustelut' — mainitse tekstissä 'BAT-päätelmät': "
            "viittaa IED:n BAT-asiakirjoihin (Best Available Techniques); "
            ...
            "- PAKOLLINEN osiossa '1. Hankkeen kuvaus' — mainitse tekstissä "
            "'Tukes S10-ohje': palonsammutus akkuvarastoissa perustuu Tukes "
            "S10-ohjeeseen; automaattinen sammutusjärjestelmä pakollinen; "
            "sammutusaineen valinta (CO₂, inerttikaasu tai vesisumu) akkukemian mukaan.\n"
            "- PAKOLLINEN osiossa '1. Hankkeen kuvaus' — mainitse tekstissä "
            "'ATEX-direktiivi 2014/34/EU': räjähdysvaarallisten tilojen luokittelu "
            ...
            "- PAKOLLINEN osiossa '1. Hankkeen kuvaus' — mainitse tekstissä 'BMS': "
            ...
            "- PAKOLLINEN osiossa '3. Luvat' — mainitse tekstissä 'UN 38.3': "
            "litiumakkujen kuljetustestaus (UN 38.3) — toimittajan esitettävä "
